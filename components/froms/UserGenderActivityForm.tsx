...
import DietaryRestrictionsInput from '@/components/forms-input/DietaryRestrictionsInput';
import AllergiesInput from '@/components/forms-input/AllergiesInput';
import NutritionGoalsInput from '@/components/forms-input/NutritionGoalsInput';
...
export default function UserGenderActivityForm({
  ...
  return (
    <ScrollView className="w-full">
      <VStack space="md" className="w-full max-w-sm mx-auto mt-2 pb-8">
        <Animated.View
        ...
        <DietaryRestrictionsInput
          ...
          setValue={(name, value) => {
            // Adaptation du type entre les composants enfants et react-hook-form
