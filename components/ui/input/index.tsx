...
const inputStyle = tva({
  base: 'border-background-300 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-tertiary-700 data-[focus=true]:hover:border-tertiary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-tertiary-300 items-center',
