...
export const VolleyballEmoji: React.FC<VolleyballEmojiProps> = ({ size = 100 }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 100 100" fill="none">
      ...
      <Circle cx="50" cy="50" r="35" fill="url(#paint0_radial_volleyball)" stroke="#E0E0E0" strokeWidth="1" />
