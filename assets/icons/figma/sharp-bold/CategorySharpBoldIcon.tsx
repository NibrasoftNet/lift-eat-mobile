 ...
 */
export const CategorySharpBoldIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 24"
  ...
  >
    ...
    <Path d="M22.1997 4.12129L14.4717 2.05029L12.4017 9.77829L20.1287 11.8483L22.1997 4.12129Z" fill={color} />
