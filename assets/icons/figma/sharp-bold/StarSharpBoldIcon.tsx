 ...
 */
export const StarSharpBoldIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 24"
  ...
  >
    ...
    <Path d="M19.0011 7.74697C19.0011 6.58497 20.2751 5.24797 21.5001 5.24797C20.3211 5.24797 19.0011 3.89697 19.0011 2.74997C19.0011 3.89697 17.6931 5.24797 16.5031 5.24797C17.6481 5.24797 19.0011 6.57797 19.0011 7.74697Z" fill={color} />
  </Svg>
);
