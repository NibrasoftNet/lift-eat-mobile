 ...
 */
export const PasswordSharpBrokenIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 24"
    ...
    {...props}
  >
    <Path d="M10.9424 12H17.2604V13.852" fill={none} stroke={color} strokeWidth="1.5" />
    ...
    <Path d="M9.845 21.25H21.5V2.75H3V21.25H5.196" fill={none} stroke={color} strokeWidth="1.5" />
  </Svg>
);
