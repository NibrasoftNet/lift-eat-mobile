...
/**
 * VolumeUpRegularTwotoneIcon component
 */
export const VolumeUpRegularTwotoneIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <Path d="M19.5845 5.90405C22.1345 9.57507 22.1429 14.4174 19.5845 18.0956" fill={none} stroke={color} strokeWidth="1.5" />
...
export default VolumeUpRegularTwotoneIcon;
