...
/**
 * ArrowLeftCircleRegularTwotoneIcon component
 */
export const ArrowLeftCircleRegularTwotoneIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export default ArrowLeftCircleRegularTwotoneIcon;
