 ...
 */
export const ChartRegularTwotoneIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
    <Path d="M16.6285 13.8269V17.0619" fill={none} stroke={color} strokeWidth="1.5" />
    <Path d="M7.37121 10.2017V17.0618" fill={none} stroke={color} strokeWidth="1.5" />
    <Path d="M12.0382 6.91919V17.0619" fill={none} stroke={color} strokeWidth="1.5" />
