 ...
 */
export const PlusSharpTwoToneIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 25"
    ...
    {...props}
  >
    <Path d="M12.2496 8.8623V16.1887M15.9173 12.5251H8.58398" fill={none} stroke={color} strokeWidth="1.5" />
