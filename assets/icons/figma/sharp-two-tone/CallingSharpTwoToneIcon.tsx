...
/**
 * CallingSharpTwoToneIcon component
 */
export const CallingSharpTwoToneIcon = ({
  color = '#212121',
  size = 24,
  ...props
}: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 25 25" fill="none" {...props}>
    <Path
      d="M14.4971 3.354C18.1981 3.765 21.1221 6.685 21.5371 10.386"
      fill='none'
      stroke={color}
      strokeWidth="1.5"
    />
    <Path
      d="M14.4971 6.89697C16.2681 7.24097 17.6521 8.62597 17.9971 10.397"
      fill='none'
      stroke={color}
      strokeWidth="1.5"
    />
...
export default CallingSharpTwoToneIcon;
