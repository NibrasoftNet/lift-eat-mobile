 ...
 */
export const PaperFailSharpTwoToneIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 24"
    ...
    {...props}
  >
    <Path d="M13.4059 15.8326L9.91211 12.3389M9.914 15.8326L13.4078 12.3389" fill={none} stroke={color} strokeWidth="1.5" />
