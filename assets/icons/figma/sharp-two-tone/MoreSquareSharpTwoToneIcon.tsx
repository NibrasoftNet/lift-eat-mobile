...
/**
 * MoreSquareSharpTwoToneIcon component
 */
export const MoreSquareSharpTwoToneIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 25"
...
export default MoreSquareSharpTwoToneIcon;
