...
/**
 * DangerTriangleRegularLightOutlineIcon component
 */
export const DangerTriangleRegularLightOutlineIcon = ({
  color = '#212121',
  size = 24,
  ...props
}: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
    <Path d="M2 3H22.0137V21.1855H2V3Z" fill={'white'} />
    <Path
...
export default DangerTriangleRegularLightOutlineIcon;
