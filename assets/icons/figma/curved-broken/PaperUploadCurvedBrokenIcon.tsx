 ...
 */
export const PaperUploadCurvedBrokenIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <Path d="M11.6152 9.97656V16.0176" fill={none} stroke={color} strokeWidth="1.5" />
    <Path d="M13.96 12.3316L11.615 9.97656L9.27002 12.3316" fill={none} stroke={color} strokeWidth="1.5" />
