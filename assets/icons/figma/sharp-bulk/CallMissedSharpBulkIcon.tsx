 ...
 */
export const CallMissedSharpBulkIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 25"
  ...
  >
    ...
    <Path d="M16.0361 11.1712L18.4621 8.74524L20.8891 11.1712L21.9491 10.1102L19.5231 7.68524L21.9491 5.25924L20.8891 4.19824L18.4621 6.62424L16.0361 4.19824L14.9751 5.25924L17.4021 7.68524L14.9751 10.1102L16.0361 11.1712Z" fill={color} />
  </Svg>
);
