 ...
 */
export const DiscoverySharpBulkIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 24"
  ...
  >
    ...
    <Path d="M8.93848 15.312L14.3745 14.123L15.5625 8.68701L10.1285 9.87701L8.93848 15.312Z" fill={color} />
  </Svg>
);
