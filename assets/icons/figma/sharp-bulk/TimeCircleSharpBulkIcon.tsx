 ...
 */
export const TimeCircleSharpBulkIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 24"
  ...
  >
    ...
    <Path d="M11.1621 13.1182L15.9421 15.9702L16.7111 14.6822L12.6621 12.2672V7.09619H11.1621V13.1182Z" fill={color} />
  </Svg>
);
