 ...
 */
export const PaperPlusSharpBulkIcon = ({
  color = '#212121',
  size = 24,
  ...props
}: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 25 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M12.2903 15.1761H14.7583V13.6761H12.2903V11.2061H10.7903V13.6761H8.31934V15.1761H10.7903V17.6461H12.2903V15.1761Z"
      fill={color}
    />
  </Svg>
);
