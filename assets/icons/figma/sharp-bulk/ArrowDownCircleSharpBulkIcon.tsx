 ...
 */
export const ArrowDownCircleSharpBulkIcon = ({
  color = '#212121',
  size = 24,
  ...props
}: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 25 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M7.72021 10.5551L12.2502 15.1061L16.7802 10.5551L15.7172 9.49707L12.2502 12.9801L8.78322 9.49707L7.72021 10.5551Z"
      fill={color}
    />
  </Svg>
);
