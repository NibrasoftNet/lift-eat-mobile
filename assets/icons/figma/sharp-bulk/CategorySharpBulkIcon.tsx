 ...
 */
export const CategorySharpBulkIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 24"
  ...
  >
    ...
    <Path d="M22.1999 4.12178L14.4719 2.05078L12.4019 9.77878L20.1289 11.8488L22.1999 4.12178Z" fill={color} />
  </Svg>
);
