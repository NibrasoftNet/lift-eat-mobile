 ...
 */
export const ArrowUpSquareCurvedLightBorderIcon = ({
  color = '#212121',
  size = 24,
  ...props
}: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M8.24805 11.6787C8.24805 11.6787 10.776 7.91471 12 7.91471C13.224 7.91471 15.748 11.6787 15.748 11.6787"
      fill={none}
      stroke={color}
      strokeWidth="1.5"
    />
