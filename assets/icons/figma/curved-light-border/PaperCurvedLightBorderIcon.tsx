...
/**
 * PaperCurvedLightBorderIcon component
 */
export const PaperCurvedLightBorderIcon = ({
  color = '#212121',
  size = 24,
  ...props
}: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
    <Path
      d="M14.3053 15.4502H8.90527"
      fill='none'
      stroke={color}
      strokeWidth="1.5"
    />
    <Path
      d="M12.2603 11.4385H8.9043"
      fill='none'
      stroke={color}
      strokeWidth="1.5"
    />
...
export default PaperCurvedLightBorderIcon;
