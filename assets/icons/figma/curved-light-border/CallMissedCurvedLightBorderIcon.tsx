 ...
 */
export const CallMissedCurvedLightBorderIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
    <Path d="M21.3281 2.75L15.3281 8.75" fill={none} stroke={color} strokeWidth="1.5" />
    <Path d="M15.3281 2.75L21.3281 8.75" fill={none} stroke={color} strokeWidth="1.5" />
