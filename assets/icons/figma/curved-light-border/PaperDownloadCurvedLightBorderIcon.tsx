...
/**
 * PaperDownloadCurvedLightBorderIcon component
 */
export const PaperDownloadCurvedLightBorderIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <Path d="M11.6606 16.0176V9.97656" fill={none} stroke={color} strokeWidth="1.5" />
    <Path d="M9.31494 13.6621L11.6599 16.0171L14.0049 13.6621" fill={none} stroke={color} strokeWidth="1.5" />
...
export default PaperDownloadCurvedLightBorderIcon;
