 ...
 */
export const CallMissedSharpLightBorderIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 25"
    ...
    {...props}
  >
    <Path d="M20.9637 5.17773L16.1113 10.0301" fill={none} stroke={color} strokeWidth="1.5" />
    <Path d="M16.1113 5.17773L20.9637 10.0301" fill={none} stroke={color} strokeWidth="1.5" />
