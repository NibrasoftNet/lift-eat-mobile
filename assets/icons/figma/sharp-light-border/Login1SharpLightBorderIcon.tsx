...
/**
 * Login1SharpLightBorderIcon component
 */
export const Login1SharpLightBorderIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 25 24"
...
export default Login1SharpLightBorderIcon;
