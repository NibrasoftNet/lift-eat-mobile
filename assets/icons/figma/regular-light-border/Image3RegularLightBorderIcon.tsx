 ...
 */
export const Image3RegularLightBorderIcon = ({
  color = '#212121',
  size = 24,
  ...props
}: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <Path
      d="M21.207 14.9509C20.284 14.0009 18.509 12.0819 16.579 12.0819C14.648 12.0819 13.535 16.3149 11.678 16.3149C9.821 16.3149 8.134 14.4009 6.646 15.6279C5.158 16.8539 3.75 19.3609 3.75 19.3609"
      fill={none}
      stroke={color}
      strokeWidth="1.5"
    />
