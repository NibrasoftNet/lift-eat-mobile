...
/**
 * TimeSquareRegularLightBorderIcon component
 */
export const TimeSquareRegularLightBorderIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <Path d="M15.391 14.0178L12 11.9948V7.63379" fill={none} stroke={color} strokeWidth="1.5" />
  </Svg>
);

export default TimeSquareRegularLightBorderIcon;
