 ...
 */
export const PaperUploadCurvedTwoToneIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <Path d="M11.6593 9.97656V16.0176M11.6593 9.97656L14.0045 12.3321M11.6593 9.97656L9.31445 12.3321" fill={none} stroke={color} strokeWidth="1.5" />
