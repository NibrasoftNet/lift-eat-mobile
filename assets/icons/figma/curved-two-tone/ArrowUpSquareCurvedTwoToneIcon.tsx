 ...
 */
export const ArrowUpSquareCurvedTwoToneIcon = ({ color = "#212121", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <Path d="M8.24805 11.6777C8.24805 11.6777 10.776 7.91373 12 7.91373C13.224 7.91373 15.748 11.6777 15.748 11.6777" fill={none} stroke={color} strokeWidth="1.5" />
  </Svg>
);
