 ...
 */
export const ChocolateDrinkRegularBoldIcon = ({ color = "#7A5548", size = 24, ...props }: IconProps) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 45 56"
