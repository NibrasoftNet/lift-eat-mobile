    ...
    return (
        <VStack className="mb-6">
            <HStack className="w-full justify-between mt-10 mx-4">
                ...
                >
                    <ButtonText size="md"> {step === IntroStepEnum.ONE ? "Next" : "Start"}</ButtonText>
            ...
            <Box className="flex-row justify-between px-6">
                <MaterialCommunityIcons name="fruit-pineapple" className={`${step === IntroStepEnum.ONE ? "bg-blue-500" : "bg-gray-500"} rounded-2xl p-2 shadow-md shadow-black`} size={30} color="white" />
                <MaterialCommunityIcons name="dumbbell" className={`${step === IntroStepEnum.TWO ? "bg-amber-500" : "bg-gray-500"} rounded-2xl p-2 shadow-md shadow-black`} size={30} color="white" />
            </Box>
        </VStack>
    );
}
