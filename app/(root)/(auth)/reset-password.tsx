        ...
        >
            <VStack className="size-full p-4 items-center justify-center gap-4">
                ...
                <Card className="flex w-full bg-transparent items-center justify-center">
                    <Text className="text-center text-2xl font-bold text-black">Reset Password</Text>
                    <Text className="text-center text-xl font-semibold text-gray-600">Create new password</Text>
                </Card>
