  ...
  useEffect(() => {
    ...
    async function initializeUser() {
      ...
      try {
        ...
        const sessionUserId = storedUserId
          ? parseInt(storedUserId, 10)
          : sessionUser?.id || 1;
        console.log(
          '[DEBUG - TABS] ID utilisateur récupéré:',
          sessionUserId,
          'Source:',
          storedUserId
            ? 'AsyncStorage'
        ...
        if (sessionUserId && sessionUserId !== userId) {
          ...
          console.log(
            "Données utilisateur rafraîchies avec l'ID de session:",
            sessionUserId,
          );
        }
      } catch (error) {
