...
import { FormOperationResult, UserGenderActivityFormServiceInterface } from "../interfaces/forms.interface";
 ...
 */
class UserGenderActivityFormService implements UserGenderActivityFormServiceInterface {
  /**
   ...
   * @param queryClient - Le client de requête pour l'invalidation du cache
  /**
   * Gère l'action d'annulation du formulaire
   * @param operation - L'opération en cours (create ou update)
