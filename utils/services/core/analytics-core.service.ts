...
/**
 * Service core pour les analyses nutritionnelles
...
class AnalyticsCoreService {
  ...
  async getUserNutritionStatistics(
    ...
    try {
      logger.info(
        LogCategory.USER,
        "Récupération des statistiques pour l'utilisateur",
        { userId },
      );
...
export const analyticsCoreService = new AnalyticsCoreService();
