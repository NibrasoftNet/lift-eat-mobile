 ...
 * Fournit des fonctionnalitu00e9s pour la gestion des objectifs d'entrau00eenement
 */

import { GoalEnum } from "@/utils/enum/user-details.enum";
import { GoalFormServiceInterface } from "../interfaces/form-input.interface";
import { logger } from "./logging.service";
import { LogCategory } from "@/utils/enum/logging.enum";

/**
 * Implu00e9mentation du service de gestion du formulaire d'objectifs
 */
class GoalFormService implements GoalFormServiceInterface {
  ...
  getGoalButtonStyles(selectedGoal: GoalEnum, buttonGoal: GoalEnum): {
    ...
    try {
      // Vu00e9rifier si le bouton correspond u00e0 l'objectif su00e9lectionnu00e9
      ...
      // Retourner des styles par du00e9faut en cas d'erreur
      return {
