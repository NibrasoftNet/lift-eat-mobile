...
import { DrawerServiceInterface } from '../interfaces/drawer.interface';

// Constantes pour la configuration des drawers
const DEFAULT_DEBOUNCE_DELAY = 300;
const DEFAULT_PAGINATION_THRESHOLD = 0.5;
const DEFAULT_ESTIMATED_ITEM_SIZE = 300;
 ...
 */
class DrawerService implements DrawerServiceInterface {
