...
export interface OptionsDrawerService {
...
class OptionsDrawerServiceImpl implements OptionsDrawerService {
  handleDetailAction(itemId: number, onDetail: () => void): void {
    try {
...
export const optionsDrawerService = new OptionsDrawerServiceImpl();
