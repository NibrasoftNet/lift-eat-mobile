...
import { CalculateCaloriesIntakeFormData, CalculateCaloriesIntakeDefaultValueProps } from "@/utils/validation/plan/calculate-calories-intake.validation";
...
class CaloriesIntakeFormService {
   ...
   * @returns Le calcul des besoins caloriques totaux
   */
  calculateCalories(data: CalculateCaloriesIntakeFormData, weight: number, weightUnit: string): number {
