 ...
 */
export const calculateTDEE = (weight: number, height: number, age: number, isMale: boolean, activityLevel: number): number => {
...
export const MacroDistribution = {
  BALANCED: {
    PROTEIN: 0.20, // 20% des calories
    CARBS: 0.50,   // 50% des calories
    FAT: 0.30,     // 30% des calories
  },
};
