  ...
  if (__DEV__) {
    try {
      ...
      console.warn = (...args: any[]) => {
        ...
        const isReanimatedWarning = args.some(arg => 
          typeof arg === 'string' && 
      ...
      console.log('[Reanimated] Warning: Warnings have been suppressed for better console readability');
    } catch (error) {
      console.error('[Reanimated] Error configuring warning suppression:', error);
    }
  }
};
