...
const Box: React.FC<BoxProps> = ({
  ...
  const boxStyles = StyleSheet.create({
    box: {
      ...
      borderTopLeftRadius: roundedTop !== undefined ? getRadiusValue(roundedTop) : roundedLeft !== undefined ? getRadiusValue(roundedLeft) : undefined,
      borderTopRightRadius: roundedTop !== undefined ? getRadiusValue(roundedTop) : roundedRight !== undefined ? getRadiusValue(roundedRight) : undefined,
      borderBottomLeftRadius: roundedBottom !== undefined ? getRadiusValue(roundedBottom) : roundedLeft !== undefined ? getRadiusValue(roundedLeft) : undefined,
      borderBottomRightRadius: roundedBottom !== undefined ? getRadiusValue(roundedBottom) : roundedRight !== undefined ? getRadiusValue(roundedRight) : undefined,
      // Flexbox
      flex,
      ...
      alignSelf,
      // Ombres
      ...(shadow ? { shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5 } : {}),
    },
  });
