...
const getStyles = (theme: ReturnType<typeof useAppTheme>) =>
  StyleSheet.create({
    ...
    heroBox:{ borderWidth:1, borderColor:'#A4C73B', borderRadius:12, padding:20, alignItems:'center', backgroundColor:'#F3F4F6', marginBottom:20, marginTop:20 },
    ...
    submitButton:{ flex:1, backgroundColor: '#A4C73B', paddingVertical:14, borderRadius:8, alignItems:'center', marginHorizontal:4 },
    submitText:{ color:'#fff', fontWeight:'700' },
    segmentContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, justifyContent: 'space-between', marginVertical: 8 },
    segmentButton: { width: '48%', paddingVertical: 10, paddingHorizontal: 12, borderWidth: 1, borderColor: '#A4C73B', borderRadius: 8, backgroundColor: '#F3F4F6', alignItems: 'center' },
