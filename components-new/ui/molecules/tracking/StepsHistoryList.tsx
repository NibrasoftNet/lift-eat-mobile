...
/**
 * Composant StepsHistoryList pour CircularProgress
 ...
 */
const StepsHistoryList: React.FC<HistoryListProps> = ({
...
const styles = StyleSheet.create({
  ...
  bottomText: {
    ...
    fontSize: 16,
    fontWeight: '500',
    lineHeight: 22.4, // 1.4 * fontSize selon Figma
    textAlign: 'center',
    marginTop: -8, // Ajustement pour coller au design Figma
  },
  emptyText: {
    fontFamily: 'Urbanist',
    fontSize: 16,
...
export default StepsHistoryList;
