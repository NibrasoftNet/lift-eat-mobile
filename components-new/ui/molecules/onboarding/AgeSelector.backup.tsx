  ...
  const scrollToSelectedValues = useCallback(() => {
    setTimeout(() => {
      try {
        ...
        console.log(
          'Erreur lors du centrage des valeurs sélectionnées:',
          error,
        );
      }
    }, 500);
  ...
  const DateItem = memo(
      ...
      return (
        <View style={styles.valueItemContainer}>
          <View style={styles.valueInnerContainer}>
            <Text style={[styles.valueText, itemStyle]}>{format(item)}</Text>

            {isSelected && (
              <View
                style={[styles.selectedLine, { backgroundColor: accentColor }]}
              />
            )}
          </View>
        </View>
    ...
    (prevProps, nextProps) => {
      ...
      return (
        ...
        Math.abs(prevProps.index - prevProps.centerIndex) ===
          Math.abs(nextProps.index - nextProps.centerIndex) &&
        ...
        <View style={styles.columnContainer}>
          ...
          <FlatList
            ...
            contentContainerStyle={{
              ...
              minHeight:
                values.length > 5
                  ? (values.length + VISIBLE_ITEMS * 2) * 67
                  : 400,
            }}
  ...
  return (
    <Box style={[styles.container, { backgroundColor }]}>
      ...
      <View style={styles.headerContainer}>
        <Text style={[styles.headerText, { color: textColors.label, flex: 1 }]}>
          Month
        </Text>
        <Text style={[styles.headerText, { color: textColors.label, flex: 1 }]}>
          Day
        ...
        <Text
          style={[styles.headerText, { color: textColors.label, width: 130 }]}
        >
          Year
        </Text>
      </View>
