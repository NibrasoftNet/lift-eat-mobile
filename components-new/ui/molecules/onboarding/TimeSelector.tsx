...
export const TimeSelector: React.FC<TimeSelectorProps> = ({
  ...
  const hourRange = mealType === 'breakfast' 
    ? [5, 6, 7, 8, 9, 10, 11] 
    : [17, 18, 19, 20, 21, 22];
    ...
    return (
      <View style={styles.columnContainer}>
        {values.map((value) => {
          ...
          const isAdjacent1 = distance === 1 || (values.length < 8 && distance === 2);
          const isAdjacent2 = distance === 2 || (values.length < 8 && distance === 3);
              ...
              <Pressable onPress={() => setSelectedValue(value)}>
                <Text style={[
                  ...
                  { 
                    ...
                    color: textColor,
                    fontWeight,
                    fontFamily: isSelected ? 'Urbanist-Bold' : 'Urbanist-SemiBold',
