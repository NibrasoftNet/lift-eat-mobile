...
const MacronutrientDistributionBar: React.FC<MacronutrientDistributionBarProps> = ({
  carbs,
  protein,
  fat,
  isDarkMode = false,
  ...
  return (
    <View style={styles.container}>
      {macronutrients.map((macro, index) => {
        ...
        const percentage = Math.min(Math.round((macro.current / macro.goal) * 100), 100);
          ...
          <View key={index} style={styles.macroColumn}>
            <View style={styles.circleContainer}>
              ...
              <View style={styles.valueContainer}>
                <Text style={[{ color: textDarkColor, fontFamily: 'Urbanist', fontSize: 24, fontWeight: '700', lineHeight: 33.6, textAlign: 'center' }]}>
                  {macro.current}
                </Text>
                <Text style={[{ color: textGrayColor, fontFamily: 'Urbanist', fontSize: 10, fontWeight: '400', lineHeight: 16, letterSpacing: 0.2, textAlign: 'center' }]}>
                  / {macro.goal} g
                </Text>
              </View>
            </View>
            ...
            <Text style={[{ color: labelGrayColor, fontFamily: 'Urbanist', fontSize: 14, fontWeight: '500', lineHeight: 22.4, letterSpacing: 0.2, textAlign: 'center' }]}>
              {macro.name}
            </Text>
          </View>
        );
